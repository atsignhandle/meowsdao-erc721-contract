...
\__\/  /~~/:/\  \:\ \:\_\/\  \:\ /  /:/\  \:\/:/ /:/\  \:\ \:\_\/\  \:\ /  /:/\__\/  \:\/:/\  \:\ /  /:/
    ...
    Usage: Call 🐱 adoptKittyCats(ETH, numberOfCats) to adopt a numberOfCats.
    ...
    (1 * 0.05 ETH = 0.05 ETH = $202)
    (5 * 0.05 ETH = 0.25 ETH = $1012)
    (10 * 0.05 ETH = 0.5 ETH = $2,025)
    (15 * 0.05 ETH = 0.75 ETH = $3,845)
    (20 * 0.05 ETH = 1 ETH = $5,000)
    (25 * 0.05 ETH = 1.25 ETH = $7,125)    
